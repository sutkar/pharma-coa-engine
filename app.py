...
st.set_page_config(page_title="Pharma COA Extractor", page_icon="🧪", layout="wide")
...
with st.sidebar:
    ...
    st.success("💰 **Pilot Pass:** ₹999 / month")
...
if uploaded_file is not None:
    ...
    with col2:
        ...
        st.download_button(
            ...
            file_name=f"Verified_{uploaded_file.name}.xlsx",
            mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
            type="primary"
        )
else:
    st.info("Upload a supplier COA PDF above to start automatic extraction.")